...
<style type="text/css">
			...
			<div class="home-form" id="prop-form" style="display: none;">
			  <form action="<?php the_permalink(); ?>" name="prop-form" method="post" enctype="multipart/form-data">
			  	<div class="dropdown">
			  		...
			  		<div class="form-left">
			  			<!-- industry -->
			  			<label for "message_naics">NAICS/Industry Type:</label>
				  		<select name="message_naics" id="naics">
				  		...
				  		<!-- other -->
				  		<label for="message_other">Other Industry (please specify): <br><input type="text" name="message_other" value="<?php echo esc_attr($_POST['message_other']); ?>"></label>
				  		<!-- revenue -->
				  		<label for "message_revenue">Amount of Revenue/year($):</label>
				  		<select name="message_revenue" id="naics">
				  			<option value="" disabled selected>-- Select --</option>
				  	...
				  	<div class="form-right">
				  		<!-- country -->
				  		<label for "message_country">Country:</label>
				  		  <select name="message_country" id="country">
				  			<option value="" disabled selected>-- Select --</option>
				          ...
				          <!-- years in biz -->
				          <label for "message_years">How many years in business?:</label>
				          	<select id="years" tabindex="14" name="message_years" class="valid">
			  	...
			  	<div class="rest" style="display: none;">
					...
					<div class="full-width">
				    	...
				    	<input type="submit" name="prop-submit">
				    </div>
				</div>
			  </form>
			</div>
			...
			<div class="home-form" id="group-form" style="display: none;">
			  <form action="<?php the_permalink(); ?>" id="group-form" method="post" enctype="multipart/form-data">
			  	<div class="dropdown">
			  		<div class="full-width">
			  		...
			  		<div class="form-left">
				  		...
				  		<select name="message_employees" id="employees">
				  			<option value="" disabled selected>-- Select --</option>
			  		...
			  		<div class="form-right">
				          ...
				          <!-- years in biz -->
				          <label for "message_years">How many years in business?:</label>
				          	<select id="message_years" tabindex="14" name="years_in_business" class="valid">
							  <option value=""> -- Select --- </option>
							  <option value="New business">New business</option>
			...
			<div class="home-form" id="ret-form" style="display: none;">
			  <form action="<?php the_permalink(); ?>" id="ret-form" method="post" enctype="multipart/form-data">
			  	<div class="dropdown">
			  		<div class="full-width">
			  			<a class="back button" href="#">&laquo; Back</a>
			  		</div>
			  		...
			  		<!-- industry -->
				  		...
				  		<label for="message_other">Other Industry (please specify): <br><input type="text" name="message_other" value="<?php echo esc_attr($_POST['message_other']); ?>"></label>
				  		<!-- # employees -->
				  		<label for "message_employees">Number of Employees:</label>
				  		<select name="message_employees" id="employees">
				  			<option value="" disabled selected>-- Select --</option>
				  			<?php $lives = getNumEmployees();
					  			foreach ($lives as $life => $value) {
			  		...
			  		<div class="form-right">
				  		<!-- $ assets -->
				  		<label for "message_assets">Retirement Plan Assets:</label>
				  		<select name="message_assets" id="assets">
				  			<option value="" disabled selected>-- Select --</option>
				  			<option value="New Business">New Business</option>
				  			<option value="$1 to $50,000">$1 to $50,000</option>
				  			<option value="$50,000 to $500,000">$50,000 to $500,000</option>
			  	...
			  	<div class="rest" style="display: none;">
					...
					<div class="form-right">
					    <h3>Upload Documents:</h3>
					    	<p><label for="upload_file">Advisory Fee Agreement (if any):<br /><input type="file" name="file[]"></label></p>
					    	<p><label for "multi_file_upload">Supporting Documents (408(b)3 Fee Schedule, Investment Policy Statement):<br /><input type="file" name="file[]" multiple></label></p>
					    <p><label for="message_human">Human Verification: <span>*</span> <br><input type="text" style="width: 60px;" name="message_human"> + 3 = 5</label></p>
					</div>
					<div class="full-width">
					    <input type="hidden" name="submitted" value="1">
					    <p><input type="submit" name="ret-submit"></p>
					</div>
				</div>
			  </form>
			</div>
